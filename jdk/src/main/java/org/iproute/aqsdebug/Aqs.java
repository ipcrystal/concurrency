...
public abstract class Aqs extends AbstractOwnableSynchronizer
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
         ...
         * Implements {@link Aqs#hasWaiters(ConditionObject)}.
         *
         * @return {@code true} if there are any waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
         ...
         * this condition.
         * Implements {@link Aqs#getWaitQueueLength(ConditionObject)}.
         *
         * @return the estimated number of waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
         ...
         * Implements {@link Aqs#getWaitingThreads(ConditionObject)}.
         *
         * @return the collection of threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *                                      returns {@code false}
